...
-- Önce mevcut varyasyonları temizle (opsiyonel)
-- DELETE FROM public.product_variations WHERE true;
...
SELECT
  p.name as ürün,
  pv.variation_type as tip,
  pv.variation_value as değer,
  pv.metadata->>'quantity' as miktar,
  pv.metadata->>'priceMultiplier' as fiyat_carpanı
