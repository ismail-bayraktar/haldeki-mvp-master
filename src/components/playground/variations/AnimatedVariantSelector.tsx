...
export const AnimatedVariantSelector: React.FC<AnimatedVariantSelectorProps> = ({
  variants,
  selectedVariant,
  onVariantSelect,
  productPrice,
  ...
  return (
    <div ref={containerRef} className="variant-selector-container">
      ...
      {isOpen && (
        <div
          className={`
            ...
            ${isOpen ? 'open opacity-100 max-h-64' : 'opacity-0 max-h-0'}
          `}
          style={{
      ...
      <style>{`
        ...
        .variant-item-animate {
          animation: variantSlideIn 250ms cubic-bezier(0.16, 1, 0.3, 1) backwards;
        }
